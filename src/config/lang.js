...
✅ You can request a withdrawal starting from 40,000 FCFA! 🛸`;
        ...
        async start(ctx) {
            return `📶 Welcome to CANAL+ COMPANY! To get started, you need to join all the partner channels below by clicking on the links to start the bot:\n\n${await getLinks()}🌹 Après avoir rejoindre tout les canaux cliquez ✅ S'inscrire`;
        },
...
✅ Tu peux demander un retrait à partir de 40 000 FCFA! 🛸`;
        ...
        async start(ctx) {
            return `📶 Bienvenue sur l'entreprise CANAL+ COMPANY, Pour y arriver dois rejoindre tout les canaux partner ci-dessous en cliquant sur les liens pour démarrer le bot : \n\n${await getLinks()}🌹 Après avoir rejoindre tout les canaux cliquez ✅ S'inscrire`;
        },
        bonus(hours, mins, secs) {
